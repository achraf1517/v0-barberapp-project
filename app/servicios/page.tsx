			...
			<nav className="p-6 border-b border-gray-800">
				<div className="max-w-7xl mx-auto flex justify-between items-center">
					...
					<div className="hidden md:flex space-x-8">
						...
						<Link
							href="/servicios"
							className="text-red-500 font-semibold border-b-2 border-red-500 pb-1"
						>
							Servicios
						</Link>
						<Link
				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-xl text-gray-300 max-w-2xl mx-auto">
							Descubre nuestra amplia gama de servicios profesionales de barbería
						</p>
					</motion.div>
					...
					<div className="space-y-16">
						{servicios.map((categoria, index) => (
							...
							>
								<h2 className="text-3xl font-black mb-8">{categoria.categoria}</h2>
								<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
									{categoria.items.map((servicio, itemIndex) => (
										<Card
											key={itemIndex}
											className="bg-gray-900/50 border-2 border-red-900/30 hover:border-red-500/50 transition-all duration-300"
										>
											<CardHeader>
			...
			<footer className="border-t border-gray-800 py-12 px-6">
				<div className="max-w-6xl mx-auto text-center">
					...
					<p className="text-gray-400">
						&copy; 2024 AURA BarberCloud. Todos los derechos reservados.
					</p>
				</div>
			</footer>
		</div>
